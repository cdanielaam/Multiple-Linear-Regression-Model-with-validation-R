...
#Multiple Linear Regression FVC Boys: (FVC_bmodel_1 selected improving accuracy inspite of non-sig parameters!!)
----->>> SELECTED MODEL
...
#Multiple Linear Regression FEV1 Boys: (FEV1_bmodel_1 selected improving accuracy inspite of non-sig parameters!!)
...
#Multiple Linear Regression FEV1FVC Boys: (FEV1FVC_bmodel_1 models are useless due to lower Rsqrd!!)
#FEV1FVC_bmodel 1 Age/Height/Weight/BMI
FEV1FVC_bmodel_1 <- lm(FEV1FVC_pre ~ Idade + Altura_cm + Peso + BMI, data = ARIA_Boys)
...
#Multiple Linear Regression FEV1FVC Girls: (FEV1FVC_bmodel_1 models are useless due to lower Rsqrd!!)
#FEV1FVC_bmodel 1 Age/Height/Weight/BMI
FEV1FVC_gmodel_1 <- lm(FEV1FVC_pre ~ Idade + Altura_cm + Peso + BMI, data = ARIA_Girls)
...
#Multiple Linear Regression FEF2575 Boys: (FEF2575_bmodel_1 selected improving accuracy inspite of non-sig parameters!!)
#FEF2575_bmodel_1 Age/Height/Weight/BMI
FEF2575_bmodel_1 <- lm(FEF2575_pre ~ Idade + Altura_cm + Peso + BMI, data = ARIA_Boys)
...
FEF2575_bmodel_2 <- lm(FEF2575_pre ~ Altura_cm + Peso, data = ARIA_Boys)
...
#FEF2575_bmodel_3 Height/Age:
FEF2575_bmodel_3 <- lm(FEF2575_pre ~ Altura_cm + Idade, data = ARIA_Boys)
...
#FEF2575_bmodel_4 Height/BMI:
FEF2575_bmodel_4 <- lm(FEF2575_pre ~ Altura_cm + BMI, data = ARIA_Boys)
...
#Multiple Linear Regression FEF2575 Girls: (FEF2575_gmodel_1 selected improving accuracy inspite of non-sig parameters!!)
#FEF2575_gmodel_1 Age/Height/Weight/BMI
FEF2575_gmodel_1 <- lm(FEF2575_pre ~ Idade + Altura_cm + Peso + BMI, data = ARIA_Girls)
...
#FEF2575_gmodel_2 Height/Weight:
FEF2575_gmodel_2 <- lm(FEF2575_pre ~ Altura_cm + Peso, data = ARIA_Girls)
...
#FEF2575_gmodel_3 Height/Age:
FEF2575_gmodel_3 <- lm(FEF2575_pre ~ Altura_cm + Idade, data = ARIA_Girls)
summary(FEF2575_gmodel_3)
#CI for the variables in FEF2575_gmodel_3:
confint(FEF2575_gmodel_3)
#Residuals for FEF2575_gmodel_3:
sigma(FEF2575_gmodel_3)/mean(ARIA_Girls$FEF2575_pre)
sigma(FEF2575_gmodel_3)/mean(G21_Girls$FEF2575_pre)

#FEF2575_gmodel_4 Height/BMI:
FEF2575_gmodel_4 <- lm(FEF2575_pre ~ Altura_cm + BMI, data = ARIA_Girls)
summary(FEF2575_gmodel_4)
#CI for the variables in FEF2575_gmodel_4:
confint(FEF2575_gmodel_4)
#Residuals for FEF2575_gmodel_4:
sigma(FEF2575_bmodel_4)/mean(ARIA_Girls$FEF2575_pre)
sigma(FEF2575_bmodel_4)/mean(G21_Girls$FEF2575_pre)

#Multiple Linear Regression FEF2575 todos: (FEF2575_model_1 selected based on lower residuals!!)
#FEF2575_model_1 Age/Height/Weight/BMI
FEF2575_model_1 <- lm(FEF2575_pre ~ Idade + Altura_cm + Peso + BMI, data = ARIA)
summary(FEF2575_model_1)
#CI for the variables in FEF2575_model_1:
confint(FEF2575_model_1)
#Residuals for FEF2575_model_1:
sigma(FEF2575_model_1)/mean(ARIA$FEF2575_pre)
sigma(FEF2575_model_1)/mean(G21$FEF2575_pre)

#FEF2575_model_2 Height/Weight:
FEF2575_model_2 <- lm(FEF2575_pre ~ Altura_cm + Peso, data = ARIA)
summary(FEF2575_model_2)
#CI for the variables in FEF2575_model_2:
confint(FEF2575_model_2)
#Residuals for FEF2575_model_2:
sigma(FEF2575_model_2)/mean(ARIA$FEF2575_pre)
sigma(FEF2575_model_2)/mean(G21$FEF2575_pre)

#FEF2575_model_3 Height/Age:
FEF2575_model_3 <- lm(FEF2575_pre ~ Altura_cm + Idade, data = ARIA)
summary(FEF2575_model_3)
#CI for the variables in FEF2575_model_3:
confint(FEF2575_model_3)
#Residuals for FEF2575_model_3:
sigma(FEF2575_model_3)/mean(ARIA$FEF2575_pre)
sigma(FEF2575_model_3)/mean(G21$FEF2575_pre)

#FEF2575_model_4 Height/BMI:
FEF2575_model_4 <- lm(FEF2575_pre ~ Altura_cm + BMI, data = ARIA)
summary(FEF2575_model_4)
#CI for the variables in FEF2575_model_4:
confint(FEF2575_model_4)
#Residuals for FEF2575_model_4:
sigma(FEF2575_model_4)/mean(ARIA$FEF2575_pre)
sigma(FEF2575_model_4)/mean(G21$FEF2575_pre)
...
#FVC Boys
  #ARIA Equations:
bland.altman.stats(G21_Boys$FVC_pre, G21_Boys$FVC_ARIA, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FVC_pre, G21_Boys$FVC_ARIA, 
                  xlab="Mean of measured FVC and FVC predicted ARIA", 
                  ylab="Measured FVC - FVC predicted ARIA",
                  two = 1.96, mode = 1, conf.int = 0.95)

  #GLI Equations:
bland.altman.stats(G21_Boys$FVC_pre, G21_Boys$FVC_GLI, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FVC_pre, G21_Boys$FVC_GLI, 
                  xlab="Mean of measured FVC and FVC predicted GLI",
                  ylab="Measured FVC - FVC predicted GLI",
                  two = 1.96, mode = 1, conf.int = 0.95)
...
#FVC Girls:
  ...
  #ARIA Equations:
bland.altman.stats(G21_Girls$FVC_pre, G21_Girls$FVC_ARIA, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FVC_pre, G21_Girls$FVC_ARIA, 
                  xlab="Mean of measured FVC and FVC predicted ARIA", 
                  ylab="Measured FVC - FVC predicted ARIA",
                  two = 1.96, mode = 1, conf.int = 0.95)

  #GLI Equations:
bland.altman.stats(G21_Girls$FVC_pre, G21_Girls$FVC_GLI, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FVC_pre, G21_Girls$FVC_GLI, 
                  xlab="Mean of measured FVC and FVC predicted GLI",
                  ylab="Measured FVC - FVC predicted GLI",
                  two = 1.96, mode = 1, conf.int = 0.95)
...
#FEV1 Boys:
  ...
  #ARIA Equations:
bland.altman.stats(G21_Boys$FEV1_pre, G21_Boys$FEV_1_ARIA, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEV1_pre, G21_Boys$FEV_1_ARIA, 
                  xlab="Mean of measured FEV1 and FEV1 predicted ARIA",
                  ylab="Measured FEV1 - FEV1 predicted ARIA",
                  two = 1.96, mode = 1, conf.int = 0.95)

  #GLI Equations:
bland.altman.stats(G21_Boys$FEV1_pre, G21_Boys$FEV1_GLI, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEV1_pre, G21_Boys$FEV1_GLI, 
                  xlab="Mean of measured FEV1 and FEV1 predicted GLI",
                  ylab="Measured FEV1 - FEV1 predicted GLI",
                  two = 1.96, mode = 1, conf.int = 0.95)

#FEV1 Girls:

    #ARIA Equations:
bland.altman.stats(G21_Girls$FEV1_pre, G21_Girls$FEV_1_ARIA, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEV1_pre, G21_Girls$FEV_1_ARIA, 
                  xlab="Mean of measured FEV1 and FEV1 predicted ARIA",
                  ylab="Measured FEV1 - FEV1 predicted ARIA",
                  two = 1.96, mode = 1, conf.int = 0.95)

    #GLI Equations:
bland.altman.stats(G21_Girls$FEV1_pre, G21_Girls$FEV1_GLI, 
                   two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEV1_pre, G21_Girls$FEV1_GLI, 
                  xlab="Mean of measured FEV1 and FEV1 predicted GLI",
                  ylab="Measured FEV1 - FEV1 predicted GLI",
                  two = 1.96, mode = 1, conf.int = 0.95)
...
#FEF2575 Boys:
    ...
    #ARIA Equations:
bland.altman.stats(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_ARIA,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_ARIA,
                    xlab="Mean of measured FEF2575 and FEF2575 predicted ARIA",
                    ylab="Measured FEF2575 - FEF2575 predicted ARIA",
                    two = 1.96, mode = 1, conf.int = 0.95)

    #GLI Equations:
bland.altman.stats(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_GLI,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_GLI,
                    xlab="Mean of measured FEF2575 and FEF2575 predicted GLI",
                    ylab="Measured FEF2575 - FEF2575 predicted GLI",
                    two = 1.96, mode = 1, conf.int = 0.95)

#FEF2575 Girls:

    #ARIA Equations:
bland.altman.stats(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_ARIA,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_ARIA,
                    xlab="Mean of measured FEF2575 and FEF2575 predicted ARIA",
                    ylab="Measured FEF2575 - FEF2575 predicted ARIA",
                    two = 1.96, mode = 1, conf.int = 0.95)

    #GLI Equations:
bland.altman.stats(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_GLI,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_GLI,
                    xlab="Mean of measured FEF2575 and FEF2575 predicted GLI",
                    ylab="Measured FEF2575 - FEF2575 predicted GLI",
                    two = 1.96, mode = 1, conf.int = 0.95)
...
#FEV1FVC Boys:
    ...
    #ARIA Equations:
bland.altman.stats(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_ARIA,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_ARIA,
                    xlab="Mean of measured FEV1/FVC and FEV1/FVC predicted ARIA",
                    ylab="Measured FEV1/FVC - FEV1/FVC predicted ARIA",
                    two = 1.96, mode = 1, conf.int = 0.95)

    #GLI Equations:
bland.altman.stats(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_GLI,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_GLI,
                    xlab="Mean of measured FEV1/FVC and FEV1/FVC predicted GLI",
                    ylab="Measured FEV1/FVC - FEV1/FVC predicted GLI",
                    two = 1.96, mode = 1, conf.int = 0.95)

#FEV1FVC Girls:

    #ARIA Equations:
bland.altman.stats(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_ARIA,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_ARIA,
                    xlab="Mean of measured FEV1/FVC and FEV1/FVC predicted ARIA",
                    ylab="Measured FEV1/FVC - FEV1/FVC predicted ARIA",
                    two = 1.96, mode = 1, conf.int = 0.95)

    #GLI Equations:
bland.altman.stats(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_GLI,
                    two = 1.96, mode = 1, conf.int = 0.95)
bland.altman.plot(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_GLI,
                    xlab="Mean of measured FEV1/FVC and FEV1/FVC predicted GLI",
                    ylab="Measured FEV1/FVC - FEV1FVC predicted GLI",
                    two = 1.96, mode = 1, conf.int = 0.95)
...
#FVC ARIA:
#Todos:
cor.test(G21$FVC_pre, G21$FVC_ARIA, method = "pearson")

ggscatter(G21, x = "FVC_pre", y = "FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted ARIA", color = "Gender")

#Boys:
cor.test(G21_Boys$FVC_pre, G21_Boys$FVC_ARIA, method = "pearson")

ggscatter(G21_Boys, x = "FVC_pre", y = "FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted ARIA")

#Girls:
cor.test(G21_Girls$FVC_pre, G21_Girls$FVC_ARIA, method = "pearson")

ggscatter(G21_Girls, x = "FVC_pre", y = "FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted ARIA")

#FVC GLI:
#Todos:
cor.test(G21$FVC_pre, G21$FVC_GLI, method = "pearson")

ggscatter(G21, x = "FVC_pre", y = "FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted GLI", color = "Gender")

#Boys:
cor.test(G21_Boys$FVC_pre, G21_Boys$FVC_GLI, method = "pearson")

ggscatter(G21_Boys, x = "FVC_pre", y = "FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted GLI")

#Girls:
cor.test(G21_Girls$FVC_pre, G21_Girls$FVC_GLI, method = "pearson")

ggscatter(G21_Girls, x = "FVC_pre", y = "FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FVC", ylab = "FVC predicted GLI")

#FEV1 ARIA:
#Todos:
cor.test(G21$FEV1_pre, G21$FEV_1_ARIA, method = "pearson")

ggscatter(G21, x = "FEV1_pre", y = "FEV_1_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted ARIA", color = "Gender")

#Boys:
cor.test(G21_Boys$FEV1_pre, G21_Boys$FEV_1_ARIA, method = "pearson")

ggscatter(G21_Boys, x = "FEV1_pre", y = "FEV_1_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted ARIA")

#Girls:
cor.test(G21_Girls$FEV1_pre, G21_Girls$FEV_1_ARIA, method = "pearson")

ggscatter(G21_Girls, x = "FEV1_pre", y = "FEV_1_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted ARIA")

#FEV1 GLI:
#Todos:
cor.test(G21$FEV1_pre, G21$FEV1_GLI, method = "pearson")

ggscatter(G21, x = "FEV1_pre", y = "FEV1_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted GLI", color = "Gender")

#Boys:
cor.test(G21_Boys$FEV1_pre, G21_Boys$FEV1_GLI, method = "pearson")

ggscatter(G21_Boys, x = "FEV1_pre", y = "FEV1_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted GLI")

#Girls:
cor.test(G21_Girls$FEV1_pre, G21_Girls$FEV1_GLI, method = "pearson")

ggscatter(G21_Girls, x = "FEV1_pre", y = "FEV1_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1", ylab = "FEV1 predicted GLI")

#FEF2575 ARIA:
#Todos:
cor.test(G21$FEF2575_pre, G21$FEF2575_ARIA, method = "pearson")

ggscatter(G21, x = "FEF2575_pre", y = "FEF2575_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted ARIA", color = "Gender")

#Boys:
cor.test(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_ARIA, method = "pearson")

ggscatter(G21_Boys, x = "FEF2575_pre", y = "FEF2575_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted ARIA")

#Girls:
cor.test(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_ARIA, method = "pearson")

ggscatter(G21_Girls, x = "FEF2575_pre", y = "FEF2575_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted ARIA")
...
#FEF2575 GLI:
#Todos:
cor.test(G21$FEF2575_pre, G21$FEF2575_GLI, method = "pearson")

ggscatter(G21, x = "FEF2575_pre", y = "FEF2575_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted GLI", color = "Gender")

#Boys:
cor.test(G21_Boys$FEF2575_pre, G21_Boys$FEF2575_GLI, method = "pearson")

ggscatter(G21_Boys, x = "FEF2575_pre", y = "FEF2575_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted GLI")

#Girls:
cor.test(G21_Girls$FEF2575_pre, G21_Girls$FEF2575_GLI, method = "pearson")

ggscatter(G21_Girls, x = "FEF2575_pre", y = "FEF2575_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEF2575", ylab = "FEF2575 predicted GLI")

#FEV1/FVC ARIA:
#Todos:
cor.test(G21$FEV1FVC_pre, G21$FEV1FVC_ARIA, method = "pearson")

ggscatter(G21, x = "FEV1FVC_pre", y = "FEV1FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted ARIA", color = "Gender")

#Boys:
cor.test(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_ARIA, method = "pearson")

ggscatter(G21_Boys, x = "FEV1FVC_pre", y = "FEV1FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted ARIA")

#Girls:
cor.test(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_ARIA, method = "pearson")

ggscatter(G21_Girls, x = "FEV1FVC_pre", y = "FEV1FVC_ARIA", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted ARIA")
...
#FEV1/FVC GLI:
#Todos:
cor.test(G21$FEV1FVC_pre, G21$FEV1FVC_GLI, method = "pearson")

ggscatter(G21, x = "FEV1FVC_pre", y = "FEV1FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted GLI", color = "Gender")

#Boys:
cor.test(G21_Boys$FEV1FVC_pre, G21_Boys$FEV1FVC_GLI, method = "pearson")

ggscatter(G21_Boys, x = "FEV1FVC_pre", y = "FEV1FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted GLI")

#Girls:
cor.test(G21_Girls$FEV1FVC_pre, G21_Girls$FEV1FVC_GLI, method = "pearson")

ggscatter(G21_Girls, x = "FEV1FVC_pre", y = "FEV1FVC_GLI", add = "reg.line", 
          conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", 
          xlab = "Measured FEV1/FVC", ylab = "FEV1/FVC predicted GLI")
